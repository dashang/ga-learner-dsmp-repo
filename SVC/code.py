...
#precision,recall,f_score = error_metric(y_test,y_pred_new,average='weighted')
...
selector = GridSearchCV(estimator=SVC(),param_grid={'kernel': ['linear', 'rbf'],'C': [100, 20, 1, 0.1]
 },scoring='accuracy')
